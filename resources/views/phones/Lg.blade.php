                ...
                <div class="services-grid">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("Apple.html") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">LG K50 S</h5></a>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("Apple.html") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">LG G5</h5></a>
                        </div>                   
                    </div>
                    <!-- ITEM THREE -->
                    <div class="service-item">
                        ...
                        <div class="service-item-title">
                            <a href="{{ url("Apple.html") }}" class="flx col-4 center v-center"><h5 class="button home-button button-clear">LG G6</h5></a>
                            <div class="selected"></div>
